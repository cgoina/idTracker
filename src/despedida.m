% 18-Mar-2014 15:37:07 A�ado probtrayectorias y quito h
% APE 01 dic 13
...
axis tight
ejes=axis;
plot3([ejes(1) ejes(1) ejes(2) ejes(2) ejes(1)],[ejes(3) ejes(4) ejes(4) ejes(3) ejes(3)],zeros(1,5),'k','LineWidth',2) % Esto ser�a m�s l�gico pintarlo antes que las trayectorias (para que quede por detr�s), pero compruebo que queda por delante de todas maneras.    
view([20 -10])
set(gca,'XTick',[],'YTick',[])
zlabel('Time (frames)')
